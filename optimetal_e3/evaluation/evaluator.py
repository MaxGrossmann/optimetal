...
class Evaluator:
    ...
    def __init__(
        ...
        self.model_kwargs = self.best_model_dict["model_kwargs"]
        self.eps_weight = self.best_model_dict["eps_weight"]
        self.drude_weight = self.best_model_dict["drude_weight"]
        self.seed = self.best_model_dict["seed"]

"""
Generate and submit batch jobs for training models automatically and also optimize their learning rate and weight decay.
...
seed = 42 # do this for multiple seeds, e.g., 1, 42, 137

# paths (depends on your setup)
config_dir  = "/scratch/magr4985/Metals/research/train_config"
...
job_dir     = "/scratch/magr4985/Train_Model"
